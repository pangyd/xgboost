...
def f(files):
    ...
    for file in files:
        ...
        single_timepoint = _(np.arange(600, 800, 1), atmosphere_tcc, surface_hpbl, surface_sp, surface_SUNSD,
...
if __name__ == "__main__":
    ...
    all_timepoint.to_csv("/usr/xgboost/deploy/gfs_process/gfs_extract_4.csv", index=False, sep=',',encoding="utf_8_sig")
