...
#     client.connect(hostname='10.106.10.125', port=3366, username='Administrator', password=quote('Test@123'), timeout=600,
#                    allow_agent=False, look_for_keys=False)
#     sftp_client = client.open_sftp()
#     remote_file = sftp_client.open('Y:\\real\\AIR2\\CityDay_2022-09-21.tsv')
#     print(remote_file)
#     remote_file.close()
# except:
#     print("连接失败")
...
# client.load_system_host_keys()
# client.set_missing_host_key_policy(paramiko.AutoAddPolicy())
# client.connect('172.16.2.125', 3389, username='Administrator', password="zfx1227")
# stdin, stdout, stderr = client.exec_command("cd E:\\Python\\DataAutoAnalyse\\autoAnalyse && cat tan.xlsx")
...
# 建立连接，获取sftp句柄
# def sftp_connect(username, password, host, port=3366):
#     client = None
#     sftp = None
#     try:
...
#         print(error)
#
# client, sftp = sftp_connect(username="test", password="abc123.", host="10.10.10.128", port=3366)
# disconnect(client)
